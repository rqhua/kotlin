        ...
        conversionScope.withParent(irFunction) {
            ...
            if (irFunction is IrSimpleFunction && firFunction != null && containingClass != null) {
                ...
                scope.processDirectlyOverriddenFunctions(firFunction.symbol) {
                    if (it == firFunction.symbol) return@processDirectlyOverriddenFunctions ProcessorAction.NEXT
                    ...
                    if (overridden == irFunction.symbol) return@processDirectlyOverriddenFunctions ProcessorAction.NEXT
